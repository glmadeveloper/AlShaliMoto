<template>
    <section class="section-content py-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="social-links">
                        <NuxtLink :to="commonObj?.facebook" target="_blank"><i class="fa-brands fa-facebook-f"></i>
                        </NuxtLink>
                        <NuxtLink :to="commonObj?.instagram" target="_blank"><i class="fa-brands fa-instagram"></i>
                        </NuxtLink>
                        <NuxtLink :to="commonObj?.linkedin" target="_blank"><i class="fa-brands fa-linkedin-in"></i>
                        </NuxtLink>
                        <NuxtLink :to="commonObj?.twitter" target="_blank"><i class="fa-brands fa-x-twitter"></i>
                        </NuxtLink>
                    </div>
                </div>
            </div>
            <div class="row my-5">
                ...
                <div class="col-sm-4">
                    <div class="contact-infobox">
                        ...
                        <bdi>{{ formatPhoneNumber(commonObj?.phone_number) }}</bdi>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="contact-infobox">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <Form as="form" class="form" @submit="onSubmit" :initial-values="initialData"
                    ...
                    ></textarea> -->
                                            <Field type="text" as="textarea" rows="5" name="message"
                                                class="form-control" :placeholder="$t('pleaseEnterYourMessage')">
                                            </Field>
                                        </div>
                                    </div>
                                </div>
...
export default {
    ...
    props: ["contactusObj", "commonObj", "locale"],
    data() {
